...
public class DBManager{
	...
	public void init_database(){
		try{
			...
			stmt.execute("CREATE TABLE IF NOT EXISTS settings(id smallint(6), password varchar(40), threshold tinyint(4), overdue_duration tinyint(4), fine_per_day tinyint(4),PRIMARY KEY (id))");
